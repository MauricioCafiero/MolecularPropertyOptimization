## AI-assisted molecule design with a taregt of minimizing docking scores for HMGCR calculated by AutoDock Vina
...
Table 2. Docking Scores (kcal/mol) for one shot molecules for each model tested. The highest docking score given in the one-shot dataset was -8.6 kcal/mol.
...
Table 3. Docking Scores (kcal/mol) for adversarially designed molecules for each model tested. The highest docking score given in the one-shot dataset was -8.6 kcal/mol.
...
Table 4. Docking Scores (kcal/mol) progression for zero-shot, 
one-shot, and adversarially designed molecules for each model tested. The highest docking score given in the one-shot dataset was -8.6 kcal/mol.

### Lipinski properties for AI-designed molecules

## AI-assisted molecule design with a taregt of minimizing the HOMO-LUMO gap as calculated with CAM-B3LYP/sto-3g in PySCF. Molecule structure optimized with MMFF.
...
Table 5. HOMO-LUMO gaps (eV) for zero shot molecules for each model tested. 
...
Table 6. HOMO-LUMO gaps (eV) for one shot molecules for each model tested. The lowest HOMO-LUMO gap given in the one-shot dataset was 5.579 eV.
...
Table 7. HOMO-LUMO gaps (eV) for adversarially designed molecules for each model tested. TThe lowest HOMO-LUMO gap given in the one-shot dataset was 5.579 eV.
...
Table 4. HOMO-LUMO gap (eV) progression for zero-shot, 
